...
from Insurance_Prediction.entity.artifact_entity import ModelPusherArtifact, ModelEvaluationArtifact
...
class ModelPusher:
    def __init__(self, model_evaluation_artifact: ModelEvaluationArtifact,
        ...
        self.insurance_estimator = InsuranceEstimator(bucket_name=model_pusher_config.bucket_name,
