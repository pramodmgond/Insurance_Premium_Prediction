from Insurance_Prediction.entity.config_entity import ModelEvaluationConfig
from Insurance_Prediction.entity.artifact_entity import ModelTrainerArtifact, DataIngestionArtifact, ModelEvaluationArtifact
from sklearn.metrics import r2_score, mean_absolute_percentage_error, mean_squared_error
from Insurance_Prediction.exception import InsuranceException
from Insurance_Prediction.constants import TARGET_COLUMN
...
class ModelEvaluation:
    ...
    def evaluate_model(self) -> EvaluateModelResponse:
        ...
        try:
            ...
            trained_model_r2_score = self.model_trainer_artifact.metric_artifact.r2_score_val
